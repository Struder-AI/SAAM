...
export const TOUR_STEPS=[
  ...
  {tab:'geometry',highlight:'import-stl',title:'Keep this part or try an STL',body:'Your part is saved, including your changes. Choose Continue with this part to keep using it, or Import STL to continue the tour with a different model.',try:'Importing keeps your current part saved. You can reopen it later with Open print. We are preparing your selected part while you decide.'},
  {tab:'toolpath',gate:'playback',highlight:'play',title:'Watch the material go down',body:'The preview starts inside an infill layer chosen by your agent. Press Play and watch for five seconds to see how the interior is printed.',try:'Scrub anywhere or change the playback speed. Next unlocks after five seconds of visible playback.'},
