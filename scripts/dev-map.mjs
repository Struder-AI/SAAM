...
if(command==='check') console.log(`Checked ${model.pages.length} pages, ${model.pages.reduce((n,p)=>n+p.nodes.length,0)} nodes.`);
...
} else throw Error('Use: node scripts/dev-map.mjs build|check');
