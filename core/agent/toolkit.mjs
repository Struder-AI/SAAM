...
export async function onboarding({role, areas = []}) {
  if (!['maker', 'developer'].includes(role)) throw Error('Choose maker or developer onboarding.');
  ...
  const ids = role === 'maker' ? ['MAKERS.md', 'skills/README.md', 'core/print/USAGE.md']
    : ['DEVELOP.md', 'core/README.md', 'skills/README.md', ...areas.flatMap(area => developmentAreas[area])];
