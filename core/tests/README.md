...
| Private-runtime setup and download packaging | [setup.test.mjs](setup.test.mjs) | Select source or prepared-archive integration for the affected distribution; [packaging checks](../../scripts/PACKAGING.md#verify-the-affected-distribution) |
