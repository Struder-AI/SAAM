...
| [vase-wall](vase-wall/SKILL.md) | Print a hollow vase or tube with a continuous spiral or reusable looping motif mapped from a regular perimeter strip onto an analytical or mesh fitted sleeve with one-sided mesh conformance. |
