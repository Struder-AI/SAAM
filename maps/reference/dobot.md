...
The configured-installation Lua output contract. See the [shared machine interface](output.md) for common motion semantics.

The [shared Studio provider](machine.md#dobot) supplies the nominal
