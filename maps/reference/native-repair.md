...
[dependencies.json](../../core/geom/native/dependencies.json) pins downloaded
toolchain inputs by URL, byte length and SHA-256 for setup tooling.
[LICENSE.GPL](../../core/geom/native/LICENSE.GPL) accompanies the native wrapper.
...
sources and hashes are in [dependencies.json](../../core/geom/native/dependencies.json).

Alternatively, use [CMakeLists.txt](../../core/geom/native/CMakeLists.txt) with installed CGAL/Eigen
...
[mesh-repair.cpp](../../core/geom/native/mesh-repair.cpp) is GPL-3.0-or-later. This is a separately
