...
**Verification.** Compare reconstructed endpoints, volume, bounds and timing; exercise relative/absolute extrusion, tiny segments, stationary events, chunk splits and dialect startup/ending fixtures. Checks: [export.test.mjs](../../core/tests/export.test.mjs), [bambu.test.mjs](../../core/tests/bambu.test.mjs), [modal-export.test.mjs](../../core/tests/modal-export.test.mjs), [gcode-stream.test.mjs](../../core/tests/gcode-stream.test.mjs).
