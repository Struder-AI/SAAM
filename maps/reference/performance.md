...
to assess a new change. See [validation ownership](lifecycle.md#validate-at-the-boundary-that-owns-the-data)
and [numerical precision](geometry.md#precision-belongs-to-a-quantity-and-an-operation) for the contracts being measured.

## Slicing speed benchmarks

For an existing shell print, [print.mjs](../../scripts/bench/print.mjs) measures the
...
[comparison requirements](../../DEVLOG.md#br-023--slicing-performance-baseline)
