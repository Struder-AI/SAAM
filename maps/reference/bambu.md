...
The experimental H2D export contract. See the [shared machine interface](output.md) for common motion semantics.
...
in existing snapshots; upgrade and regenerate a chosen bundle to use v3, with
normal plan/toolpath review invalidation. Existing exports and delivery files
are not rewritten.
