...
The experimental PacScript output contract and unresolved installation requirements. See the [shared machine interface](output.md) for common motion semantics.
...
[nominal presentation model](machine.md#denso-vp-6242) supplies
