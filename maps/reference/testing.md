...
| `core/region/offset.mjs`, Clipper normalization and offset compatibility | [offset.test.mjs](../../core/tests/offset.test.mjs), [offset-junctions.test.mjs](../../core/tests/offset-junctions.test.mjs), [offset-remnants.test.mjs](../../core/tests/offset-remnants.test.mjs) | Fill, infill, drape and vase consumers as affected |
...
| Studio settings, server, saved-print opening, export names and busy indicator | [studio-settings.test.mjs](../../core/tests/studio-settings.test.mjs), [studio-open.test.mjs](../../core/tests/studio-open.test.mjs), [studio-print-name.test.mjs](../../core/tests/studio-print-name.test.mjs), [studio-spinner.test.mjs](../../core/tests/studio-spinner.test.mjs), [studio-lifetime.test.mjs](../../core/tests/studio-lifetime.test.mjs), [studio-tour-ui.test.mjs](../../core/tests/studio-tour-ui.test.mjs), [studio-reconnect.test.mjs](../../core/tests/studio-reconnect.test.mjs) | Viewer lifetime/owner isolation, workflow, regional workflow and machine-specific Studio delivery |
| Studio active-work dots and pane-specific viewport fade, prepared results, overlapping requests and interruption; the agent's Studio event queue, owner-authenticated event long-poll and ownerless-store visibility | [studio-work.test.mjs](../../core/tests/studio-work.test.mjs), [studio-agent-ui.test.mjs](../../core/tests/studio-agent-ui.test.mjs), [studio-agent.test.mjs](../../core/tests/studio-agent.test.mjs), [studio-events.test.mjs](../../core/tests/studio-events.test.mjs) | MCP request coordination; tour readiness and completion cues |
