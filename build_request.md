...
- Remaining: In the order given in [dev-map/HANDOFF.md](dev-map/HANDOFF.md#what-remains-in-order): callback targets as references; closure-owned state on member pages; entering array-method callbacks; loop accumulation; finding rows on function pages; thoughtful root clustering. Done 2026-09-21: the invocation edge, the repeated-box ruling, the two code-shape sites, the island review.
