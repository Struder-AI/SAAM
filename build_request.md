...
- Remaining: physical acceptance of this file: mixed-diameter recognition, startup/homing, material mapping, service clearance, nozzle offsets and deposition after repeated changes. Resolve firmware/dispatch discrepancies from observed evidence; extended AMS/HT configurations also need physical acceptance. Same-nozzle PLA AMS commands passed in AMS-09/10; the generated v12 project representation failed AMS-11 and remains unresolved. Automatic power-loss recovery has no output contract; do not claim either from the dual test.
