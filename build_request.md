...
- Context: Fill rows, wall loops, rings, skin rows, lip rings and axial cladding tracks now continue as deposited connectors; the short-travel advisory exempts required transitions and agents report findings.
...
- Context: Four September 12 contributions were withdrawn to restore the agreed architecture. The user retained three concepts for selective review and singled out the material library as committed future work. [Minimal implementation guidance](BUILDERS.md#engineering-priorities).
