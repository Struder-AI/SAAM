...
- Remaining: In the order given in [dev-map/HANDOFF.md](dev-map/HANDOFF.md#what-remains-in-order): leaves drawn on the map above; closure-owned state on member pages; loop accumulation; finding rows on function pages; thoughtful root clustering. Done 2026-09-21: the invocation edge, callback targets as references, array-method callbacks entered, the repeated-box ruling, the two code-shape sites, the island review.
